...
(function (global, factory) {
  ...
  (global = global || self, global['w-panel'] = factory());
  ...
  var script = {
    ...
    computed: {
      ...
      useHeaderStyle: function useHeaderStyle() {
        ...
        var vo = this;
        var s = {};
        s['padding'] = "".concat(vo.padding, "px");
        s['border-bottom'] = '1px solid #ddd';
        s['background-color'] = color2hex(vo.headerBackgroundColor);
        s['border-radius'] = "".concat(vo.borderRadius, "px ").concat(vo.borderRadius, "px 0 0");
        s['display'] = 'flex';
      ...
      useContentStyle: function useContentStyle() {
        ...
        if (!vo.hasHeader) {
          ch = "".concat(vo.borderRadius, "px ").concat(vo.borderRadius, "px");
        }

        if (!vo.hasFooter) {
          cf = "".concat(vo.borderRadius, "px ").concat(vo.borderRadius, "px");
        }

        s['border-radius'] = "".concat(ch, " ").concat(cf);
        return s;
      },
      useFooterStyle: function useFooterStyle() {
        ...
        s['border-radius'] = "0 0 ".concat(vo.borderRadius, "px ").concat(vo.borderRadius, "px");
        return s;
      }
    },
    methods: {}
  ...
  var __vue_render__ = function() {
    ...
    return _c(
      "div",
      { class: { shadow: _vm.borderShadow }, style: [_vm.usePanelStyle] },
      [
        _vm.hasHeader
          ? _c(
              "div",
              { style: [_vm.useHeaderStyle] },
              [
                _vm._t("icon"),
                _vm._v(" "),
                _c(
          ...
          : _vm._e(),
        _vm._v(" "),
        _c("div", { style: [_vm.useContentStyle] }, [_vm._t("content")], 2),
        _vm._v(" "),
        _vm.hasFooter
          ? _c("div", { style: [_vm.useFooterStyle] }, [_vm._t("footer")], 2)
          : _vm._e()
      ]
    )
  };
  ...
  __vue_render__._withStripped = true;
    ...
    var WPanel = normalizeComponent_1(
