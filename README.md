...
> **Note:** w-component-vue is mainly composed of `vuetify`, `element-ui` and `@mdi/js`.
...
```alias
<script src="https://cdn.jsdelivr.net/npm/w-component-vue@1.4.32/dist/w-component-vue.umd.js"></script>
```
Directly use:
```alias
//app and component
