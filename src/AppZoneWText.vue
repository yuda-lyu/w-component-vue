            ...
            <template v-if="modeBorder==='emboss'">
                ...
                <template v-if="modeShell==='pure'">
                    ...
                    <div class="bk">
                        ...
                        <w-text :borderRadius="5" v-model="WText.text"></w-text>
                    </div>
                    ...
                    <div class="bk">
                        ...
                        <w-text
                            :leftIcon="mdiCheckUnderlineCircle"
                            :leftIconColorFocus="'pink accent-2'"
                            v-model="WText.text"
                        ></w-text>
                    </div>
                ...
                <template v-if="modeShell==='shell'">
                    ...
                    <div class="bk">
                        ...
                        <w-shell-material
                            ...
                            :leftIcon="mdiPaw"
                        >
                            <w-text :small="false" v-model="WText.text"></w-text>
                        </w-shell-material>
                    </div>
                    ...
                    <div class="bk">
                        ...
                        <w-shell-material
                            ...
                            :leftIcon="mdiPaw"
                        >
                            <w-text :editable="false" v-model="WText.text"></w-text>
                        </w-shell-material>
                    </div>
            ...
            <template v-if="modeBorder==='border'">
                ...
                <template v-if="modeShell==='pure'">
                    ...
                    <div class="bk">
                        <demolink
                            :kbname="'w-text'"
                            :casename="'leftIcon & leftIconColor & leftIconColorFocus & borderColor & borderColorFocus & backgroundColorFocus'"
                            :kind="'border'"
                            :shell="'pure'"
                        ></demolink>
                        ...
                        <w-text
                            ...
                            :leftIconColorFocus="'cyan darken-1'"
                            v-model="WText.text"
                        ></w-text>
                    </div>
                ...
                <template v-if="modeShell==='shell'">
                    ...
                    <div class="bk">
                        <demolink
                            :kbname="'w-text'"
                            :casename="'titleColor & leftIconColor & borderColor & borderColorFocus & backgroundColorFocus'"
                            :kind="'border'"
                            :shell="'shell'"
                        ></demolink>
...
<script>
import { mdiCheckUnderlineCircle, mdiAvTimer, mdiSend, mdiAccountOutline, mdiArrowRightDropCircleOutline, mdiPaw } from '@mdi/js'
