    ...
    props: {
        pathItems: {
            ...
            default: () => [
                ...
                'https://cdn.jsdelivr.net/npm/w-aggrid-vue@2.0.22/dist/w-aggrid-vue.umd.js',
                'https://cdn.jsdelivr.net/npm/xlsx@0.17.3/dist/xlsx.full.min.js', //download與upload會使用, 一併預載
            ],
        },
        opt: {
            type: Object,
