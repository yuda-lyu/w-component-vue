 ...
 * @vue-prop {String} [uncheckedSwitchCircleColor='#fafafa'] 輸入可編輯時，無效(false|'n')切換器鈕扣區顏色字串，預設'#fafafa'
 * @vue-prop {String} [uncheckedSwitchCircleColorHover='#fff'] 輸入滑鼠移入時可編輯時，無效(false|'n')切換器鈕扣區顏色字串，預設'#fff'
 ...
 * @vue-prop {String} [checkedSwitchBarColorDisabled='#ececec'] 輸入不可編輯時，有效(true|'y')切換器滑動區顏色字串，預設'#ececec'
 * @vue-prop {String} [uncheckedSwitchBarColor='#c5c5c5'] 輸入可編輯時，無效(false|'n')切換器滑動區顏色字串，預設'#c5c5c5'
 * @vue-prop {String} [uncheckedSwitchBarColorHover='#ccc'] 輸入滑鼠移入時可編輯時，無效(false|'n')切換器滑動區顏色字串，預設'#ccc'
