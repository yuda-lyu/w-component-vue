<template>
    ...
    >
        ...
        >
            ...
            <div
                ref="divBar1"
                :style="`position:absolute; z-index:1; left:${(r1)*panelWidth-bw/2}px; width:${barSize}px; height:${panelHeight}px; border-left:${barBorderSize}px solid ${useBarBorderColor}; border-right:${barBorderSize}px solid ${useBarBorderColor}; cursor:col-resize; user-select:none; touch-action:none;`"
            >
            ...
            <div
                ref="divBar2"
                :style="`position:absolute; z-index:1; left:${(r2)*panelWidth-bw/2}px; width:${barSize}px; height:${panelHeight}px; border-left:${barBorderSize}px solid ${useBarBorderColor}; border-right:${barBorderSize}px solid ${useBarBorderColor}; cursor:col-resize; user-select:none; touch-action:none;`"
            >
                <div :style="`width:${barSize}px; height:${panelHeight}px; background:${useBarColor};`"></div>
            </div>
