<template>
    <div>
        ...
        <div class="head1" style="cursor:pointer;" title="open for copy link to view component" onclick="window.open('https://yuda-lyu.github.io/w-component-vue/examples/app.html?cmp='+this.innerText,'_blank')">w-tree-draggable</div>
        ...
        <div style="padding:0px;">
            ...
            <div class="bk">
                ...
                <w-tree-draggable
                    :items="WTreeDraggable.option1.items"
                >
            ...
            <div class="bk">
                ...
                <w-tree-draggable
                    :items="WTreeDraggable.option2.items"
                    :bindChildren="'items'"
                >
                    <template v-slot:item="props">
                        <div style="padding:7px;">
            ...
            <div class="bk">
                ...
                <w-tree-draggable
                    :items="WTreeDraggable.option3.items"
                    :indent="30"
                >
                    <template v-slot:item="props">
                        <div style="padding:7px;">
            ...
            <div class="bk">
                ...
                <w-tree-draggable
                    :items="WTreeDraggable.option4.items"
                    :textDisabled="'禁止拖曳至自己子節點當中'"
                    :textDisabledColor="'pink accent-3'"
                    :textDisabledPaddingLeft="13"
                    :textDisabledFontSize="'0.8rem'"
                    :textDisabledBackgroundColor="'rgba(255,255,255,0.8)'"
                >
                    <template v-slot:item="props">
                        <div style="padding:7px;">
                            <v-chip
