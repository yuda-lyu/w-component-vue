<template>
    <div>
        ...
        <div class="head1" style="cursor:pointer;" title="open for copy link to view component" onclick="window.open('https://yuda-lyu.github.io/w-component-vue/examples/app.html?cmp='+this.innerText,'_blank')">w-highcharts-vue-dyn</div>
        ...
        <div style="padding:0px;">
            ...
            <div class="bk">
                ...
                <w-highcharts-vue-dyn
                    style="width:620px;"
                    :options="WHighchartsVueDyn.options2"
                ></w-highcharts-vue-dyn>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue-dyn
                    style="width:620px;"
                    :options="WHighchartsVueDyn.options3"
                ></w-highcharts-vue-dyn>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue-dyn
                    style="width:620px;"
                    :options="WHighchartsVueDyn.options4"
                ></w-highcharts-vue-dyn>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue-dyn
                    style="width:620px;"
                    :options="WHighchartsVueDyn.options5"
                ></w-highcharts-vue-dyn>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue-dyn
                    style="width:620px;"
                    :options="WHighchartsVueDyn.options6"
                ></w-highcharts-vue-dyn>
        ...
        return {
            'WHighchartsVueDyn': {
                ...
                'options3': {
                    ...
                    tooltip: {
                        formatter: function () {
                            return '<b>' + this.series.name + ', age ' + this.point.category + '</b><br/>' + 'Population: ' + Math.abs(this.point.y).toFixed(1) + '%'
                        }
                    },
                    series: [{
                        name: 'Male',
