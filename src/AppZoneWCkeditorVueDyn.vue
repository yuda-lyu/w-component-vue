<template>
    <div>
        ...
        <div class="head1"><span style="cursor:pointer;" title="open for copy link to view component" onclick="window.open('//yuda-lyu.github.io/w-component-vue/examples/app.html?cmp='+this.innerText,'_blank')">w-ckeditor-vue-dyn</span></div>
        ...
        <div style="padding:0px;">
            ...
            <div class="bk">
                <demolink
                    :kbname="'w-ckeditor-vue-dyn'"
                    :casename="'default'"
                ></demolink>

                <w-ckeditor-vue-dyn
                    style="width:620px;"
                    v-model="WCkeditorVueDyn.content"
                ></w-ckeditor-vue-dyn>
            ...
            <div class="bk">
                ...
                <w-ckeditor-vue-dyn
                    style="width:620px;"
                    :settings="WCkeditorVueDyn.settings"
                    v-model="WCkeditorVueDyn.content"
                ></w-ckeditor-vue-dyn>
...
import WCkeditorVueDyn from './components/WCkeditorVueDyn.vue'
