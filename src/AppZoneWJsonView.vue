    ...
    <div>
        ...
        <div style="padding-left:30px;">
            ...
            <div class="bk" style="display:block;">
                <demolink
                    :kbname="'w-json-view'"
                    :casename="'large data (20000 lines)'"
                    :kind="'nokind'"
                    :shell="'pure'"
                ></demolink>
...
// console.log(btoa(encodeURIComponent(JSON.stringify(data))))
// console.log(JSON.parse(decodeURIComponent(atob(b))))
