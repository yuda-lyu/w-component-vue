<template>
    <div class="bkh">
        ...
        <div style="padding-top:30px;">
            ...
            <div class="bk" v-if="filterCaseCat==='filter'">
                <demolink
                    :kbname="'w-tree'"
            ...
            <div class="bk" v-if="filterCaseCat==='style'">
                <demolink
                    :kbname="'w-tree'"
            ...
            <div class="bk" v-if="filterCaseCat==='activable'">
                <demolink
                    :kbname="'w-tree'"
            ...
            <div class="bk" style="display:block;" v-if="filterCaseCat==='selectable'">
                <demolink
                    :kbname="'w-tree'"
                    :casename="'selectable'"
                ></demolink>
            ...
            <div class="bk" style="display:block;" v-if="filterCaseCat==='large'">
                <demolink
                    :kbname="'w-tree'"
...
export default {
    ...
    data: function() {
        return {
            ...
            'filterCaseCats': [
                { name: 'basic' }, { name: 'toggle' }, { name: 'filter' }, { name: 'style' },
                { name: 'activable' }, { name: 'draggable' }, { name: 'operatable' }, { name: 'editor' },
                { name: 'slot' }, { name: 'selectable' }, { name: 'large' },
            ],
            'WTree': {
