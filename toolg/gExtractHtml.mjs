...
function writeHtml(v) {
    ...
    function getAppTmp() {
        ...
        $('div.bk').before(`<div class="head1" style="cursor:pointer;" title="open for copy link to view component" onclick="window.open('https://yuda-lyu.github.io/w-component-vue/examples/app.html?cmp='+this.innerText,'_blank')">${v.kbname}</div>`) //於bk前插入, 添加組件kbname
